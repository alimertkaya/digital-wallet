package com.alimertkaya.digitalwallet.exchangerate.service.impl;

import com.alimertkaya.digitalwallet.exchangerate.dto.ExchangeApiResponse;
...
public class ExchangeRateServiceImpl implements ExchangeRateService {
    ...
    @CircuitBreaker(name = "exchangeRateApi", fallbackMethod = "syncFromCacheFallback")
    ...
    @SuppressWarnings("unused") // Resilience4j @CircuitBreaker tarafından reflection ile çağrılır
    private Mono<Void> syncFromCacheFallback(Exception e) {
        log.warn("Dış kur API'si erişilemiyor, mevcut DB kurları geçerli kalıyor. Hata: {}", e.getMessage());
        return Mono.empty();
    }
